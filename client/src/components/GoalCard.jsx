    ...
    useEffect( () => {
      ...
      async function getGoalInfo(){
        ...
        if(currYear > parseInt(dateOfGoal[2])){
          ...
          setGoal('expired')
        }else if(currYear === parseInt(dateOfGoal[2]) && currMonth > parseInt(dateOfGoal[0])){
          //if the year is the same, but month is older than goal month
          setGoal('expired')
        }else if(currYear === parseInt(dateOfGoal[2]) && currMonth === parseInt(dateOfGoal[0]) && currDay > parseInt(dateOfGoal[1])){
