...
function FriendsModal() {
    ...
    return (
        <button style={{borderRadius:"50%", border:"none", width: "6vw", height:"6vw", minWidth: "75px", minHeight: "75px", backgroundColor:"#282c34", position:"fixed", bottom: 20, right: 60}} onClick={()=>setModalOpened(true)}>
