...
function FriendProfile() {
    ...
    async function getGoalInfo(goal){
        let goalData = await axios.get(`http://http://54.175.184.234:3000//userProfile/${fireId}/${goal}`);
    ...
    useEffect( () => {
        ...
        async function getUserInfo(){
            let userData = await axios.get(`http://http://54.175.184.234:3000//user/${fireId}/getFriendInfo`)
